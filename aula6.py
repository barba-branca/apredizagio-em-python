...
# isso se chama polimorfismo ele ta utilisando 1 operador de soma para 2 situaçaopra fazer coisas diferentes
...
# str, int, float, bool
# colando dentro de uma funçao print
print('1', type(1))
# e colocar um valor e o tipo do daquele valor o python vai entender que é uma string 
...
# quando a gente colocar parentese dentro de parentese o python primeiro vai ler o parentese do meio depos os outros
...
print(str(11) + 'b')
# pra ele indentificar indentificar esse dois valores e string a gente precisa colocar o str para ele concatenar a string
